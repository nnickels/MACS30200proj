...
ggplot(comparison_models, aes(X5, value, color = model)) +
  geom_line(size = 1) +
  geom_point(size = 0.3) +
  theme_bw() +
...
The text book test set accuracy is 97.8%. The set accuracy here is  higher, at 98.21%. The text book test set loss is 7.5%, and the test set loss here is higher, at 17%. Therefore, our accuracy is improved, and our loss has not imrpoved compared to the text book. 
